...
# ╔═╡ 33d5f604-c0df-11f0-9780-73ef7982176e
begin
...
# ╔═╡ 960255c7-437a-4dc6-9c7c-535e0e470d96
function η(λ, ω)
    return (2π / λ) * sqrt(hbar / (2 * m * ω))
end

# ╔═╡ a877f212-074d-4976-8485-bc76975bf3b6
@bind FoV Slider(0.1:0.01:10.0, 2.0, true)

# ╔═╡ c097644b-8307-434b-af9a-e7666295f170
begin
	vs = range(0.1,FoV,500)
	etas = η.(411*nm, 2*pi.*vs*MHz)
	plot(vs, etas,
		xlabel="ν (MHz)",
		ylabel="η_411",
		title="Lamb-Dicke for Yb⁺ 411 (Colinear trap axis)",
		linewidth=2)
end
