...
# ╔═╡ 32f2f57e-3e49-4958-9bf5-fbeb0fc77bab
begin
...
# ╔═╡ 139e5406-c17c-11f0-aeb1-d9ed141e789a
begin
	using PlutoUI, Plots
	function Temp(v)
		return (hbar*2*pi*v*MHz)/(kB)*10^3
	end
end

# ╔═╡ f4faf781-0744-4a8a-820d-068d17d71435
@bind FoV Slider(0.1:0.1:100, show_value=true, default=2.0)

# ╔═╡ 62cd30da-2b21-4cf7-b288-1eef3f9e484c
begin
	vs = 0.0:FoV
	Ts = Temp.(vs)
	plot1 = plot(
	    vs, Ts,
	    label="Temperature associated with Frequency",
	    lw=2,
	    xlabel="ν (MHz)",
	    ylabel="T (mK)",
	    title="Temperature associated with Frequency",
	    size=(700,400)
	)
	plot(plot1)
end
