...
# ╔═╡ a640294c-b8c8-11f0-8b3b-a3db813ab1a8
begin
	using PlutoUI, Plots
end

# ╔═╡ 19fd9c03-8025-4397-8705-944bb5283f1c
begin
	function TempToAvgN(kBT_over_ħω)
	    1 / (exp(1 / kBT_over_ħω) - 1)
	end
end

# ╔═╡ 4dded4f8-e865-47d5-8bd7-1239a4acf9e4
### Slider cell
@bind FoV Slider(1:0.1:20, show_value=true, default=5.0)

# ╔═╡ 1e9d0370-1d93-4f91-b72e-e84a2941131b
### Plot cell
begin
	kBTs = range(0.01, FoV, length=300)
	avgN = TempToAvgN.(kBTs)
	refline = kBTs .- 0.5
	...
	plot(
	    ...
	    xlabel="k_B T / ħω",
	    ylabel="⟨n⟩",
	    title="Temperature to Mean Occupation ⟨n⟩ = tr(n̂ ρ̂_th)",
	    legend=:bottomright,
	    size=(700,400)
	)
	plot!(kBTs, refline, color=:gray, linestyle=:dot, label="k_BT/ħω − 1/2")
end
